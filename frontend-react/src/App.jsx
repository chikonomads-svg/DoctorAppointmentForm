...
const DOCTOR_INFO = {
  ...
  specialization: 'Diabetes, Blood Pressure, Thyroid, Asthma, COPD, and Abdominal diseases',
      ...
      <div className="form-card" style={{padding:0}}>
        ...
        <div style={{padding:'var(--space-lg)'}}>
          <div className="rx-patient-grid">
            ...
            <div className="rx-patient-field" style={{gridColumn:'1 / -1'}}><label>Address</label><input type="text" placeholder="Patient address..." value={data.patient_address||''} onChange={e=>update({patient_address:e.target.value})}/></div>
          </div>
